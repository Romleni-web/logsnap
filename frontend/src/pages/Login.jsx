    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#020617] p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-10 glass-card p-12 rounded-[2.5rem] relative z-10 border-t-4 border-t-blue-600">
        <div className="text-center">
          ...
          <h2 className="text-4xl font-display font-black tracking-tighter text-white mb-2 italic uppercase">OPERATOR LOGIN</h2>
          <p className="text-slate-500 font-bold text-[10px] tracking-[0.3em] uppercase">Secure Access Terminal // V27.5</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-slate-500 tracking-widest uppercase ml-1">IDENTIFIER</label>
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-slate-500 tracking-widest uppercase ml-1">ACCESS KEY</label>
              <div className="relative group">
        ...
        <div className="pt-6 text-center border-t border-slate-800/50">
          <p className="text-slate-600 text-[10px] font-black tracking-[0.2em] uppercase">
            UNREGISTERED? <Link to="/register" className="text-blue-500 hover:text-blue-400 underline underline-offset-8 decoration-2 ml-2 transition-colors">ENROLL NOW</Link>
          </p>
        </div>
      </div>
    </div>
