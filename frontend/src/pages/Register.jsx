    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gray-50 p-6">
      <div className="w-full max-w-sm space-y-8 bg-white border border-gray-200 p-10 rounded-xl shadow-sm">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-black mb-1">Create an account</h2>
          <p className="text-gray-500 text-xs font-medium uppercase tracking-wider">Join the LogSnap Network</p>
        </div>
